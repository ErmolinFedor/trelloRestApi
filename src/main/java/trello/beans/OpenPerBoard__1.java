...
public class OpenPerBoard__1 {
    ...
    public String toString() {
        ...
        sb.append(OpenPerBoard__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OpenPerBoard__1) == false) {
            return false;
        }
        OpenPerBoard__1 rhs = ((OpenPerBoard__1) other);
