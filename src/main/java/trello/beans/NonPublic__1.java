...
public class NonPublic__1 {
    ...
    public String toString() {
        ...
        sb.append(NonPublic__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("fullName");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof NonPublic__1) == false) {
            return false;
        }
        NonPublic__1 rhs = ((NonPublic__1) other);
