...
public class PerCard__5 {
    ...
    public String toString() {
        ...
        sb.append(PerCard__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerCard__5) == false) {
            return false;
        }
        PerCard__5 rhs = ((PerCard__5) other);
