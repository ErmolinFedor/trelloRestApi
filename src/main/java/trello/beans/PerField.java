...
public class PerField {
    ...
    public String toString() {
        ...
        sb.append(PerField.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerField) == false) {
            return false;
        }
        PerField rhs = ((PerField) other);
