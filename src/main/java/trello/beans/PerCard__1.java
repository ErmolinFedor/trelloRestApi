...
public class PerCard__1 {
    ...
    public String toString() {
        ...
        sb.append(PerCard__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerCard__1) == false) {
            return false;
        }
        PerCard__1 rhs = ((PerCard__1) other);
