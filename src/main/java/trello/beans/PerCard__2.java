...
public class PerCard__2 {
    ...
    public String toString() {
        ...
        sb.append(PerCard__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerCard__2) == false) {
            return false;
        }
        PerCard__2 rhs = ((PerCard__2) other);
