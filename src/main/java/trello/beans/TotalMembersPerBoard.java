...
public class TotalMembersPerBoard {
    ...
    public String toString() {
        ...
        sb.append(TotalMembersPerBoard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalMembersPerBoard) == false) {
            return false;
        }
        TotalMembersPerBoard rhs = ((TotalMembersPerBoard) other);
