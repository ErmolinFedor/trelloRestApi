...
public class TotalPerList__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalPerList__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalPerList__1) == false) {
            return false;
        }
        TotalPerList__1 rhs = ((TotalPerList__1) other);
