...
public class PerChecklist {
    ...
    public String toString() {
        ...
        sb.append(PerChecklist.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerChecklist) == false) {
            return false;
        }
        PerChecklist rhs = ((PerChecklist) other);
