...
public class Card__1 {
    ...
    @Expose
    private List<Object> customFieldItems = new ArrayList<Object>();
    ...
    public List<Object> getCustomFieldItems() {
        return customFieldItems;
    }

    public void setCustomFieldItems(List<Object> customFieldItems) {
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("customFieldItems");
        sb.append('=');
        sb.append(((this.customFieldItems == null)?"<null>":this.customFieldItems));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.customFieldItems == null)? 0 :this.customFieldItems.hashCode()));
