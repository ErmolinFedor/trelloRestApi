...
public class UniquePerAction {
    ...
    public String toString() {
        ...
        sb.append(UniquePerAction.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UniquePerAction) == false) {
            return false;
        }
        UniquePerAction rhs = ((UniquePerAction) other);
