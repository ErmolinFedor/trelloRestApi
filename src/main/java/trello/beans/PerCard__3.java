...
public class PerCard__3 {
    ...
    public String toString() {
        ...
        sb.append(PerCard__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerCard__3) == false) {
            return false;
        }
        PerCard__3 rhs = ((PerCard__3) other);
