...
public class TotalPerBoard__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalPerBoard__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalPerBoard__1) == false) {
            return false;
        }
        TotalPerBoard__1 rhs = ((TotalPerBoard__1) other);
