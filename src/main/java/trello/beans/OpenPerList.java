...
public class OpenPerList {
    ...
    public String toString() {
        ...
        sb.append(OpenPerList.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OpenPerList) == false) {
            return false;
        }
        OpenPerList rhs = ((OpenPerList) other);
