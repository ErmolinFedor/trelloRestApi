...
public class PerBoard__1 {
    ...
    public String toString() {
        ...
        sb.append(PerBoard__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerBoard__1) == false) {
            return false;
        }
        PerBoard__1 rhs = ((PerBoard__1) other);
