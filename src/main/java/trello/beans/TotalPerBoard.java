...
public class TotalPerBoard {
    ...
    public String toString() {
        ...
        sb.append(TotalPerBoard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalPerBoard) == false) {
            return false;
        }
        TotalPerBoard rhs = ((TotalPerBoard) other);
