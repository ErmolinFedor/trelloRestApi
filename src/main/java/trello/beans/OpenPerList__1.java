...
public class OpenPerList__1 {
    ...
    public String toString() {
        ...
        sb.append(OpenPerList__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OpenPerList__1) == false) {
            return false;
        }
        OpenPerList__1 rhs = ((OpenPerList__1) other);
