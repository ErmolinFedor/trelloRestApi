...
public class PerAction {
    ...
    public String toString() {
        ...
        sb.append(PerAction.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerAction) == false) {
            return false;
        }
        PerAction rhs = ((PerAction) other);
