...
public class PerCard__4 {
    ...
    public String toString() {
        ...
        sb.append(PerCard__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerCard__4) == false) {
            return false;
        }
        PerCard__4 rhs = ((PerCard__4) other);
