...
public class TotalPerList {
    ...
    public String toString() {
        ...
        sb.append(TotalPerList.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalPerList) == false) {
            return false;
        }
        TotalPerList rhs = ((TotalPerList) other);
